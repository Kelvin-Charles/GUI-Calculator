...
def cal():
    root = Tk()
    root.title("Kelvin GUI  Calculator")
    root.resizable(0,0)
    ...
    button15 = Button(root, text='futa', bg=other_button_bg, padx=10, pady=3,
    ...
    button16 = Button(root, text='Futa yote', bg=other_button_bg, padx=10, pady=3,
    ...
    exit = Button(root, text='Toka', fg='white', bg='black', command=quit, height=1, width=7)
